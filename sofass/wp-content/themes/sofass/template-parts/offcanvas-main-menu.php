...
<div class="goal-offcanvas dark-menu-sidebar hidden-sm hidden-xs"> 
            ...
            <div class="header-right pull-left">
                ...
                ?>
                    <div class="pull-right">
                        <a class="wishlist-icon" href="<?php echo esc_url($wishlist_url);?>" title="<?php esc_attr_e( 'View Your Wishlist', 'sofass' ); ?>"><i class="ti-heart"></i>
                ...
                <?php if ( sofass_get_config('show_login_account', true) ) { ?>
                    <div class="pull-right">
    ...
    <div class="offcanvas-middle">
        <?php if ( has_nav_menu( 'vertical-menu' ) ): ?>
            <div class="vertical-wrapper">
                <div class="title-vertical bg-theme"><i class="fa fa-bars" aria-hidden="true"></i> <span class="text-title"><?php echo esc_html__('all Departments','sofass') ?></span> <i class="fa fa-angle-down show-down" aria-hidden="true"></i></div>
                <?php
                    $args = array(
    ...
    <div class="offcanvas-bottom">
        ...
        <?php } ?>
         <?php
            $social_links = sofass_get_config('header_social_links_link');
            $social_icons = sofass_get_config('header_social_links_icon');
