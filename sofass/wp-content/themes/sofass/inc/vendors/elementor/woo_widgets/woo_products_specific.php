...
class Sofass_Elementor_Woo_Products_Specific extends Widget_Base {

	public function get_name() {
        return 'sofass_woo_products_specific';
    }

	public function get_title() {
        return esc_html__( 'Goal Products Specific', 'sofass' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'product_ids', [
                'label' => esc_html__( 'Product IDS', 'sofass' ),
                'type' => Controls_Manager::TEXTAREA,
                'placeholder' => esc_html__( 'Enter your product id here', 'sofass' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'inner-list' => esc_html__('Item List', 'sofass'),
                ),
                'default' => 'inner',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'carousel_vertical' => esc_html__('Vertical', 'sofass'),
	...
	protected function render() {
        ...
        if ( $product_ids ) {
        ?>
            <div class="widget woocommerce widget-products-deal <?php echo esc_attr($product_item.' '.$el_class); ?> <?php if (sofass_get_config('colection_gutter', false)) { ?> colection_gutter <?php } ?>">
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Sofass_Elementor_Woo_Products_Specific );
} else {
    Plugin::instance()->widgets_manager->register( new Sofass_Elementor_Woo_Products_Specific );
}