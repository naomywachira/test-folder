...
class Sofass_Elementor_Vertical_Menu extends Elementor\Widget_Base {

	public function get_name() {
        return 'sofass_vertical_menu';
    }

	public function get_title() {
        return esc_html__( 'Goal Header Vertical Menu', 'sofass' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            'show_menu',
            [
                'label' => esc_html__( 'Show menu condition', 'sofass' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => [
                    'show-always' => esc_html__( 'Always', 'sofass' ),
                    'show-in-home' => esc_html__( 'In home page', 'sofass' ),
                    'show-hover' => esc_html__( 'When hover', 'sofass' ),
                ],
        ...
        $this->add_control(
            'bg_title_color',
            [
                'label' => esc_html__( 'Background Color Title', 'sofass' ),
        ...
        $this->add_control(
            'link_color',
            [
                'label' => esc_html__( 'Link Color', 'sofass' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_control(
            'link_hover_color',
            [
                'label' => esc_html__( 'Link Hover Color', 'sofass' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Sofass_Elementor_Vertical_Menu );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Sofass_Elementor_Vertical_Menu );
}