...
class Sofass_Elementor_Social_Links extends Widget_Base {

    public function get_name() {
        return 'sofass_social_links';
    }

    public function get_title() {
        return esc_html__( 'Goal Social Links', 'sofass' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_small' => esc_html__('Small', 'sofass'),
                ),
                'default' => 'style1'
            ]
        );
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__( 'Social', 'sofass' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Sofass_Elementor_Social_Links );
} else {
    Plugin::instance()->widgets_manager->register( new Sofass_Elementor_Social_Links );
}