...
class Sofass_Elementor_Team extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Goal Teams', 'sofass' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'title', [
                'label' => esc_html__( 'Social Title', 'sofass' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Social Title' , 'sofass' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'link',
            [
                'label' => esc_html__( 'Social Link', 'sofass' ),
                'type' => Controls_Manager::TEXT,
                'input_type' => 'url',
                'placeholder' => esc_html__( 'Enter your social link here', 'sofass' ),
            ]
        );
        ...
        $this->add_control(
            'name', [
                'label' => esc_html__( 'Member Name', 'sofass' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Name' , 'sofass' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'job', [
                'label' => esc_html__( 'Member Job', 'sofass' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Job' , 'sofass' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'description', [
                'label' => esc_html__( 'Member Description', 'sofass' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__( 'Member Description' , 'sofass' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'sofass' ),
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs('style_tabs');
                ...
                $this->add_control(
                    'name_color',
                    [
                        'label' => esc_html__( 'Name Color', 'sofass' ),
                ...
                $this->add_control(
                    'icon_bg',
                    [
                        'label' => esc_html__( 'Icon Bg Color', 'sofass' ),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
            ...
            $this->add_control(
                'border-radius',
                [
                    'label' => esc_html__( 'Border Radius Icon', 'sofass' ),
            ...
            $this->add_responsive_control(
                'width',
                [
                    'label' => esc_html__( 'Width Icon', 'sofass' ),
            ...
            $this->add_responsive_control(
                'height',
                [
                    'label' => esc_html__( 'Height Icon', 'sofass' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range' => [
                        'px' => [
            ...
            $this->add_group_control(
                ...
                [
                    'label' => esc_html__( 'Icon Typography', 'sofass' ),
            ...
            $this->add_responsive_control(
                'padding_inner',
                [
                    'label' => esc_html__( 'Padding Information', 'sofass' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
            ...
            <div class="top-image">
                ...
                ?>
                    <div class="team-image">
                        <?php echo sofass_get_attachment_thumbnail($settings['img_src']['id'], 'full'); ?>
                    </div>
                <?php } ?>
                <ul class="social">
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Sofass_Elementor_Team );
} else {
    Plugin::instance()->widgets_manager->register( new Sofass_Elementor_Team );
}