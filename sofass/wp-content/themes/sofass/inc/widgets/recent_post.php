...
class Sofass_Recent_Post extends Goal_Widget {
    public function __construct() {
        parent::__construct(
            'goal_recent_post',
            esc_html__('Goal Recent Posts Widget', 'sofass'),
            array( 'description' => esc_html__( 'Show list of recent post', 'sofass' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'sofass' ); ?></label>
...
if ( function_exists('goal_framework_reg_widget') ) {
    goal_framework_reg_widget('Sofass_Recent_Post');
}