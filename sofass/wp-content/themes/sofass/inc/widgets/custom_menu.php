...
class Sofass_Custom_Menu extends Goal_Widget {
    public function __construct() {
        parent::__construct(
            'goal_custom_menu',
            esc_html__('Goal Custom Menu Widget', 'sofass'),
            array( 'description' => esc_html__( 'Show custom menu', 'sofass' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'sofass' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('style')); ?>">
                <?php echo esc_html__('Style:', 'sofass' ); ?>
            </label>
            <br>
...
if ( function_exists('goalframework_reg_widget') ) {
    goal_framework_reg_widget('Sofass_Custom_Menu');
}