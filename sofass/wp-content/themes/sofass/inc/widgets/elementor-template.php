...
class Sofass_Widget_Elementor_Template extends Goal_Widget {
    public function __construct() {
        parent::__construct(
            'goal_elementor_template',
            esc_html__('Goal Show Elementor Template Widget', 'sofass'),
            array( 'description' => esc_html__( 'Show Elementor Template', 'sofass' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $options = [ '' => esc_html__('Choose a template', 'sofass' ) ];
        if ( !empty( $templates ) ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('item_template_id')); ?>">
                <?php echo esc_html__('Choose Template:', 'sofass' ); ?>
            </label>
            <br>
...
if ( did_action( 'elementor/loaded' ) ) {
    if ( function_exists('goal_framework_reg_widget') ) {
        goal_framework_reg_widget('Sofass_Widget_Elementor_Template');
    }
}