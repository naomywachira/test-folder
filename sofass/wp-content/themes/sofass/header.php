...
<body <?php body_class(); ?>>
<?php if ( sofass_get_config('preload', true) ) {
	$preload_icon = sofass_get_config('media-preload-icon');
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php
		$header = apply_filters( 'sofass_get_header_layout', sofass_get_config('header_type') );
		get_template_part( 'headers/'.$header );
		if ( !empty($header) ) {
			sofass_display_header_builder($header);
		} else {
