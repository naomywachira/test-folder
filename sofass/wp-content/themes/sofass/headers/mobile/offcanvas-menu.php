<div id="goal-mobile-menu" class="goal-offcanvas hidden-lg"> 
    <div class="goal-offcanvas-body">
            ...
            <div class="container">
                <div class="row flex-middle">
                    ...
                    <div class="text-center col-xs-6">
                        <?php
                            $logo = sofass_get_config('media-mobile-logo');
                            $logo_url = '';
                            if ( !empty($logo['id']) ) {
                            ...
                            <div class="pull-right">
                                ...
                                <div class="top-cart">
                                    ...
                                    <div class="goal-topcart">
                                        <div class="cart">
                                            <a class="mini-cart" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e('View your shopping cart', 'sofass'); ?>">
        ...
        <div class="middle-offcanvas">
            ...
            <?php
                if ( defined('SOFASS_WOOCOMMERCE_ACTIVED') && sofass_get_config('show_searchform', true) ) {
            ...
            <nav id="menu-main-menu-navbar" class="navbar navbar-offcanvas" role="navigation">
                <?php
                    ...
                    $args = array(
                        ...
                        'walker' => new Sofass_Mobile_Menu()
                    );
                    wp_nav_menu($args);

                ?>

                <?php if ( sofass_get_config('show_login_register', true) ) { ?>
                    <a class="my-account" href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>">
                        <?php if ( is_user_logged_in() ) { ?>
                            <?php esc_html_e('MY ACCOUNT', 'sofass'); ?>
                        <?php }else{ ?>
                            <?php esc_html_e('LOGIN & REGISTER', 'sofass'); ?>
                        <?php } ?>
                    </a>
                <?php } ?>
            </nav>
        </div>
        <?php if ( is_active_sidebar( 'header-mobile-bottom' ) || sofass_get_config('show_login_register', true) ) { ?>
