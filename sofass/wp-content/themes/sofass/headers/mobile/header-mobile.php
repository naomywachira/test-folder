<div id="goal-header-mobile" class="header-mobile hidden-lg hidden-md clearfix">    
    <div class="container-fluid">
        ...
        <?php if ( sofass_get_config('show_vertical_menu') && has_nav_menu( 'vertical-menu' ) ): ?>
            <div class="row">
                <div class="bottom-mobile clearfix">
                    <div class="col-xs-12">
                        <h4 class="text-title mobile-vertical-menu-title"><span><?php echo esc_html__('All Departments','sofass') ?></span><i aria-hidden="true" class="fa fa-angle-down pull-right"></i></h4>
                    </div>
                </div>
            </div>
        <?php endif; ?>
            ...
            <nav class="navbar navbar-offcanvas navbar-static" role="navigation">
                <?php
                    $args = array(
                        ...
                        'walker' => new Sofass_Mobile_Vertical_Menu()
                    );
                    wp_nav_menu($args);
                ?>
            </nav>
