...
if ( 'left' === $layout ||  'right' === $layout ) {
    if( sofass_get_config('product_archive_fullwidth') ) {
...
?>
    <section id="main-container" class="page-shop margin-top-40 <?php echo apply_filters('sofass_woocommerce_content_class', 'container');?>">
                ...
                <div id="dokan-content" class="store-page-wrap woocommerce" role="main">
                    ...
                    <div id="goal-shop-products-wrapper" class="goal-shop-products-wrapper <?php echo esc_attr($layout_type); ?>" data-layout_type="<?php echo esc_attr($layout_type); ?>">
                        ...
                        <?php } else { ?>
                            ...
                            <p class="dokan-info"><?php esc_html_e( 'No products were found of this vendor!', 'sofass' ); ?></p>
