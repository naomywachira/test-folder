...
$style_class = sofass_get_config('shop_top_categories_style', 'style1');
$style = '';
if ( in_array($style_class, array('style1', 'style2', 'style4', 'style5')) ) {
    $image = sofass_get_config('shop_top_categories_breadcrumb_image');
	...
	<div class="top-categories-inner">
		<div class="inner">
			...
			<ul class="list-category-products">
		    	<?php sofass_category_menu($display_type); ?>
		    </ul>
	    </div>
    </div>
</div>