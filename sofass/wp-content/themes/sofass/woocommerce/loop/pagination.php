...
$pagination_type = sofass_get_config('product_pagination', 'default');
...
?>
	<div class="ajax-pagination <?php echo trim($pagination_type == 'loadmore' ? 'loadmore-action' : 'infinite-action'); ?>">
		...
		<a href="#" class="radius-5x goal-loadmore-btn"><?php esc_html_e( 'Load More Items', 'sofass' ); ?></a>
		<a href="#" class="radius-5x goal-allproducts"><?php esc_html_e( 'All products loaded.', 'sofass' ); ?></a>
	</div>
<?php
} else {
?>
