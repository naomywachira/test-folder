...
$display_mode = sofass_woocommerce_get_display_mode();
...
<?php 
	...
	if ( empty($e_template_id) ) {
		$e_template_id = sofass_get_config('shop_elementor_template');
	}
	if( !empty($e_template_id) ) {
		$check_elementor = 'has-elementor';
	}
?>
<?php if ( sofass_get_config('show_shop_top_categories') ) { ?>
    <?php
        wc_get_template_part('content-product_top_cat');
    ?>
<?php } else { ?>
	<div class="shop-normal">
		<?php do_action( 'sofass_woo_template_main_before' ); ?>
	</div>
<?php } ?>

<section id="main-container" class="page-shop <?php echo esc_attr($check_elementor); ?> <?php echo apply_filters('sofass_woocommerce_content_class', 'container');?>">
					...
					<?php
						if ( is_product_taxonomy() ) {
							...
							<div class="category-description">
								<?php
								if ( $e_template_id ) {
									echo Sofass_Elementor_Extensions::render_page_content($e_template_id);
							...
							?>
							<div class="category-description">
								<?php echo Sofass_Elementor_Extensions::render_page_content($e_template_id); ?>
							</div>
							<?php
						}
					?>
