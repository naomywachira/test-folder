...
$woo_display = sofass_woocommerce_get_display_mode();
if ( $woo_display == 'list' ) { 	
...
<?php
	...
	if(!empty($columns)){
		...
		$woocommerce_loop['columns'] = sofass_woocommerce_shop_columns(4);
	}
	// Ensure visibility
	...
	$item_style = sofass_get_config('product_item_style', 'v1');
	if ( $item_style == 'v1' ) {
		$item_style = '';
	}
	?>
