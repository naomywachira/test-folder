...
?>
<section id="main-container" class="main-content single-blog <?php echo apply_filters( 'sofass_blog_content_class', 'container' ); ?> inner">
				...
				<div id="content" class="site-content detail-post" role="main">
					<?php
						...
						while ( have_posts() ) : the_post();
							...
							if ( sofass_get_config('show_blog_releated', false) ): ?>
